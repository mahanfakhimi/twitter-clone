import { EmojiIcon, GifIcon, MediaIcon, PollIcon, ScheduleIcon } from "../icons";

const TweetForm = () => {
  return (
    <div className="flex gap-x-5 flex-1 p-5 border-b border-b-neutral-200 dark:border-b-neutral-800">
      <img
      ...
      <div className="w-full">
        <input type="text" placeholder="Whats happing?" className="bg-transparent h-12 text-lg border-none w-full dark:text-white placeholder-neutral-500" />
        <div className="flex items-center justify-between mt-10">
          <div>
            <button className="p-2 rounded-full hover:bg-sky-500 hover:bg-opacity-10 transition-all">
              <MediaIcon className="fill-sky-500 w-5 h-5 cursor-pointer" />
            </button>
            <button className="p-2 rounded-full hover:bg-sky-500 hover:bg-opacity-10 transition-all">
              <GifIcon className="fill-sky-500 w-5 h-5 cursor-pointer" />
            </button>
            <button className="p-2 rounded-full hover:bg-sky-500 hover:bg-opacity-10 transition-all">
              <PollIcon className="fill-sky-500 w-5 h-5 cursor-pointer" />
            </button>
            <button className="p-2 rounded-full hover:bg-sky-500 hover:bg-opacity-10 transition-all">
              <EmojiIcon className="fill-sky-500 w-5 h-5 cursor-pointer" />
            </button>
            <button className="p-2 rounded-full hover:bg-sky-500 hover:bg-opacity-10 transition-all">
              <ScheduleIcon className="fill-sky-500 w-5 h-5 cursor-pointer" />
            </button>
          </div>
          <button className="py-1.5 px-5 font-semibold transition-all text-white bg-sky-500 hover:bg-sky-600 rounded-full">Tweet</button>
        </div>
      </div>
    </div>
  );
